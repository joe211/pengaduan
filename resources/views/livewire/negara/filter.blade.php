            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type='text' wire:model="tahun" wire:change="filter" id='tahun' autocomplete="off" class="form-control" onchange="Livewire.emit('reloadTable', this.value,  this.tws)"/>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    document.addEventListener('livewire:load', function () {
        Livewire.on('reloadTable', function (value, tws) {
