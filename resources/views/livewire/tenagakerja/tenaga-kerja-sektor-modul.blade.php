        ...
        <div class="row">
            <div class="col">
                <div class="box">
                    ...
                    <h3>Penyerapan Tenaga Kerja {{ $header }} Tahun {{$tahun ?? date('Y') }} berdasarkan Sektor Usaha</h3>
                    </div>
                        <table class="table table-bordered b-1 border-success ">
                            <thead class="text-center bg-success">
                                <tr>
                                    <th rowspan="3" class="align-middle">No</th>
                                    <th rowspan="3" class="align-middle">Sektor Usaha</th>
                            ...
                            <tfoot class="text-center bg-success">
                                <tr>
