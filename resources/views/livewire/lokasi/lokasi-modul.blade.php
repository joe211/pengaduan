    ...
    <div wire:loading.remove>
        ...
        <div class="row">
                ...
                <div class="box">
                    <div class="box-body analytics-info">  
                        <div class="text-center">
                            @if($triwulan)
                                <button wire:click="ExportExcelLokasi" class="btn btn-sm btn-primary">Export to Excel</button>
                            @endif
                            <h3>Realisasi {{ $header }} {{ $tahun ?? date('Y') }} berdasarkan LOKASI</h3>
                        </div>
                            ...
                            <table class="table table-bordered">
                                <thead class="text-center bg-success">
                                    <tr>
                                        ...
                                        <th rowspan="2" class="align-middle">Kabupaten/Kota</th>
            ...
            <div class="col">
                <div class="box">
                    <div class="box-body analytics-info">
                        <h4 class="box-title">{{ $selectedValue ?: "PMDN/PMA" }} PER LOKASI</h4>
                        <div class="box-body analytics-info">
