    ...
    <div wire:loading.remove>
        {{-- Data Tahun {{ $tahun ?? date('Y') }} --}}
                ...
                <div class="box">
                    <div class="box-body analytics-info">
                        <div class="text-center">
                            <h3>Realisasi Triwulan {{ $tw }} {{ $tahun ?? date('Y') }} berdasarkan NEGARA ASAL</h3>
                        </div>
                            ...
                            <table class="table table-bordered">
                                <thead class="text-center bg-success">
                                    <tr>
                                        ...
                                        <th colspan="4" class="align-middle">PMA</th>

                                    </tr>
                                    <tr>
                                        <th colspan="2">INVESTASI</th>
                                        <th rowspan="2" class="align-middle">TKI</th>
                                        <th rowspan="2" class="align-middle">TKA</th>
                                    </tr>
                                    <tr>
                                        <th>Investasi (Dlm $)</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ number_format($items->tambahan_investasi_asli, 0, '.', '.') }}</td>
                                ...
                                <tfoot class="text-center">
                                    <tr>
                                        ...
                                        <td>{{ number_format($subTotalJumInvestasiAsli, 0, '.', '.')  }}</td>
            ...
            <div class="col">
                <div class="box">
                    <div class="box-body analytics-info">
                        <h4 class="box-title">PER ASAL NEGARA</h4>
                        <div class="box-body analytics-info">
