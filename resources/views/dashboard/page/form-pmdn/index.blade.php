      ...
      <div class="col-12">
          <div class="box">
              <div class="box-header">						
                  ...
                  <a href="{{ action('Backend\pmdnController@create') }}" class="btn btn-success mb-2 mr-2 float-right"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Data</a>
              </div>
              <div class="box-body">
...
<script>
    $(document).ready(function(){
           ...
           serverSide: true,
           ajax: {
           url: "{{ url('dashboard/form-pmdn/table') }}",
           },
           columns: [
           ...
           function deleteData()
           {
                $('#ModalHapus').on('show.bs.modal', function(e) {
                    ...
                    $('.TombolHapus').on('click',function(e)
                    {
                        ...
                        $.ajax({
                            url:"{{url('dashboard/form-pmdn/delete')}}/" + idDelete,
                            type: 'POST',
