    ...
    <div class="row">			  
        <div class="col-lg-12 col-12">
              <div class="box">
                ...
                <!-- /.box-header -->
                <form class="form" method="POST" action="{{ action('Backend\pmaController@store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group @error('file') error @enderror">
                          <label>File PMA Excel <span class="text-danger">*</span></label>
                  ...
                  <div class="col-md-3">
                    <div class="form-group @error('kurs') error @enderror">
                      ...
                      <input type="text" name="kurs" value="{{ old('kurs') }}" class="form-control" placeholder="Masukan Kurs">
                      @error('kurs')
                      <div class="help-block"><ul role="alert"><li>{{$message}}</li></ul></div>
                      @enderror
                    </div>
...
@push('js')
  <script src="{{ asset('assets/backend/vendor_components/select2/dist/js/select2.full.js')}}"></script>
	<script src="{{ asset('assets/backend/vendor_components/formatter/jquery.formatter.js')}}"></script>	
	<script src="{{ asset('assets/backend/js/pages/formatter.js')}}"></script>	
