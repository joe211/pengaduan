                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group @error('nama') error @enderror">
                            ...
                            <input type="text" name="nama" value="{{ old('nama',$edit->nama) }}" class="form-control" placeholder="Masukan Nama">
                            @error('nama')
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group @error('email') error @enderror">
                          ...
                          <input type="text" name="email" value="{{ old('email',$edit->email) }}" class="form-control" placeholder="Masukan Email">
                          @error('email')
                          <div class="help-block"><ul role="alert"><li>{{$message}}</li></ul></div>
                          @enderror
                        </div>
