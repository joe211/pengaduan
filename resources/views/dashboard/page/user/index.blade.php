      ...
      <div class="col-12">
          <div class="box">
              <div class="box-header">						
                  ...
                  <a href="{{ action('Backend\UserController@create') }}" class="btn btn-success mb-2 mr-2 float-right"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Data</a>
              </div>
              <div class="box-body">
           ...
           function deleteData()
           {
                $('#ModalHapus').on('show.bs.modal', function(e) {
                    ...
                    $('.TombolHapus').on('click',function(e)
                    {
                        ...
                        $.ajax({
                            url:"{{url('dashboard/user/delete')}}/" + idDelete,
                            type: 'POST',
