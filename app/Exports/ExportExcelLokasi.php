...
class ExportExcelLokasi implements FromCollection, WithHeadings, WithMapping, WithStyles
{
    protected $data;
    ...
    public function headings(): array
    {
        ...
        return [
            ['Ralisasi '.$this->header.' '.$this->tahun.' Berdasarkan LOKASI'],
            ['No', 'Kabupaten/kota', 'Proyek', $this->selectedValue],
