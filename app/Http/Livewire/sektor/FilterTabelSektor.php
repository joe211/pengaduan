...
class FilterTabelSektor extends Component
{
    public $tahun;
    public $realisasi;
    // Filters
    ...
    public function render()
    {
        ...
        return view('livewire.sektor.filter-tabel-sektor', ['tws' => $tws]);
    }

    public function filter()
    {
        $this->emitTo('sektor.tabel-sektor-modul', 'reloadTable', $this->tahun, $this->tw);
